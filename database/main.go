...
func initializeAppWithServiceAccount() *firebase.App {
	...
	opt := option.WithCredentialsFile("../../MeetOverDB.json")
	config := &firebase.Config{ProjectID: "meetoverdb"}
...
func createCustomToken(app *firebase.App) string {
	...
	token, err := client.CustomToken("pacereedworks")
	if err != nil {
...
func main() {
	...
	token := "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..iQJNy3eEhxxMPQ97xQVZCnpKYiE8oXj7sh2g1PgEb8oc7Uktk3gZf9G7AeV7zUpg7ugug3TyES6IFPzNksHROibSMnLCh2gkQ0v9jrankHm5OzWqT8lsee9UxwQ8c5iUQYe6ZZ8HRR4HDcIr7-rJNvj4MKzio_9irF-y7YqspkoFG6PS9dqWDHykYIMWGLENX9nw_kimr2ceUKREwpBh1WjBMNdD_hpmUI-wGw1GQKDpzrzS6j3cMxtYojioTCejSH6pJWfPbhRuajXlCAAj_hCEsQ5biGwQ-49oixM6QrDb09P9E_GbaYvSza6TCFtO4zxVXKc6omeLQfZ9X3mdBA"
	//_ = createCustomTokenWithClaims(app)

	_ = verifyIDToken(app, token)
	cloudStorage()
